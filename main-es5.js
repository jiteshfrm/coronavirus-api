...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function HomeComponent_div_87_span_5_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var statewiseData_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function HomeComponent_div_87_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_div_87_div_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_div_87_div_27_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 58);
    ...
    function HomeComponent_div_87_tr_42_span_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 58);
      ...
      if (rf & 2) {
        var district_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function HomeComponent_div_87_tr_42_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_div_87_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_87_Template_a_click_2_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r18);

          var statewiseData_r2 = ctx.$implicit;

          var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r17.getDistrict(statewiseData_r2.state);
        });
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        ...
        key: "getDistrict",
        value: function getDistrict(state) {
          var _this3 = this;

          return this.utility.getDistrict().subscribe(function (resp) {
            //console.log(state);
            for (var key in resp) {
              if (resp.hasOwnProperty(state)) {
                var element = resp[state];

                if (key == state) {
                  for (var dkey in element) {
                    if (element.hasOwnProperty(dkey)) {
                      var district = element[dkey];
                      _this3.districtData = Object.entries(district);
                    }
                  }
                }
              }
            ...
            console.log(_this3.districtData);
          });
        }
      }, {
        key: "getIndiaData",
        value: function getIndiaData() {
          ...
          return this.utility.getIndiaData().subscribe(function (resp) {
            console.log(resp.statewise);
            _this4.indiaTotalCases = resp.statewise[0];
            _this4.statewiseData = resp.statewise;

            _this4.statewiseData.shift();
          });
        }
      }]);
